...
def transferdicoms(subject,day):
	...
	allfunc={}
	allfunc[1]=['rest', 'faces1', 'faces2', 'gonogo1', 'gonogo2', 'gonogo3', 'gonogo4', 'gonogo5', 'gonogo6', 'gonogo7']
	allfunc[2]=['exfunc', 'gonogo1', 'gonogo2', 'gonogo3', 'gonogo4', 'gonogo5', 'gonogo6', 'gonogo7', 'gonogo8', 'gonogo9']
	allfunc[3]=['exfunc','gonogo1', 'gonogo2', 'gonogo3', 'gonogo4', 'gonogo5', 'gonogo6', 'gonogo7', 'gonogo8','faces1', 'faces2', 'rest' ]
	anat=['scout', 'T1w']
	fmap=['fmap1', 'fmap2']
	...
	rest = [key for key,val in NDICOM.items() if val==rest_TR]
